...
class Config:
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'I4NsTg8faUgqTGLNmxVB45KPV52cWic'
    MAIL_SERVER = os.environ.get('MAIL_SERVER', 'mail.shop4nysc.com')
    MAIL_PORT = int(os.environ.get('MAIL_PORT', '465'))
    MAIL_USE_SSL = os.environ.get('MAIL_USE_SSL', 'true').lower() in ['true', 'on','1']
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'ihufied@shop4nysc.com'
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or r'%oc1ThhKk%if'
